...
**Z3** is one of the world's most advanced **SMT solvers** developed by Microsoft.
...
> Oh, Z3, I am thinking of two numbers, `x` and `y`. All I know is that `x + y = 20`, and also that `x` must be greater than `15`.
...
The thumbnail image is from Hashicorp Documentation [Why use Vault](https://developer.hashicorp.com/vault/tutorials/get-started/why-use-vault)